...
export class ConversationService {
    ...
    public apiGetFullConversation(c: Conversation) {
        ...
        for (var i = 0; i < 20; i++) {
            if (i % 2 == 0) {
                data.push(new Message('2017-05-01T13:58:23', 'Hello this is the message number : ' +
                                                             i, 'Ali Conners', 'ali.conners@tindev.com', 'user@localhost'));
            } else {
                data.push(new Message('2017-05-01T13:58:23', 'Hello this is the message number : ' +
                                                             i, 'Tindev User', 'user@localhost', 'ali.conners@tindev.com'));
            }
        }
